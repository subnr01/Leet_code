...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DListNode addition = ((DList) myList).newNode(item,(DList)this.myList,this,this.next);
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    DListNode addition = ((DList) myList).newNode(item, (DList)this.myList, this.prev, this);
    addition.prev.next = addition;
    addition.next.prev = addition;
    myList.size++;
    }
