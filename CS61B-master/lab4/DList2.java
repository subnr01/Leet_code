...
public class DList2 {
  ...
  public void insertFront(int i) {
          ...
          DListNode2 oldhead = this.head.next;
          newfront.prev = this.head;
          newfront.next = oldhead;
          this.head.next = newfront;
          oldhead.prev = newfront;
          size++;
  ...
  public void removeFront() {
      if (this.size == 0){
          ...
          DListNode2 oldfront = this.head.next;
          oldfront.next.prev = this.head;
